...
class MeanShift:
    def __init__(self, epsilon=1e-5, band_width=2, min_fre=5, bin_seeding=False):
        self.epsilon = epsilon
        self.band_width = band_width
        self.min_fre = min_fre  # 可以作为起始质心的球体内最少的样本数目
        self.bin_seeding = bin_seeding
        # self.radius2 = self.band_width ** 2  # 高维球体半径的平方
        self.radius2 = self.band_width
...
if __name__ == '__main__':
    ...
    data, label = make_blobs(n_samples=500, centers=20,
                             cluster_std=1.2, random_state=5)
